    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            ...
            {alert && (
                <div className="fixed left-1/2 top-6 z-[110] -translate-x-1/2 transition-all duration-500">
                    <div className={`flex items-center gap-3 rounded-xl border px-5 py-3 shadow-xl backdrop-blur-md ${
                        alert.type === "success" ? "bg-slate-900/95 border-emerald-500/20 text-emerald-400" : "bg-red-100 border-rose-500/20 text-red-700"
                    }`}>
            ...
            <div className="bg-[#F8F9FA] rounded-[2.5rem] shadow-2xl w-full max-w-2xl p-8 md:p-10 relative animate-in fade-in zoom-in duration-200">
                ...
                <h2 className="text-2xl font-bold text-gray-800 mb-8 ml-1">Modifier le stagiaire</h2>
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input name="nom" value={champs.nom || ''} onChange={handleChange} placeholder="Nom"
                            className="p-3.5 rounded-2xl border-2 border-blue-500 bg-white outline-none font-medium" required />
                    </div>
                    ...
                    <div className="md:col-span-2 flex flex-col gap-1.5">
                        ...
                        <div className="relative">
                            <select name="formation_id" value={champs.formation_id || ""} onChange={handleChange} 
                                className="w-full p-3.5 rounded-2xl border border-gray-200 bg-[#F1F3F5] outline-none appearance-none font-medium" required>
                    ...
                    <div className="md:col-span-2 flex justify-end gap-4 mt-8">
                        ...
                        <button type="submit" disabled={loading} 
                            className="px-10 py-3 bg-blue-600 text-white rounded-2xl font-bold hover:bg-blue-700 shadow-lg shadow-blue-200 transition disabled:opacity-50 active:scale-95">
